...
loss_weighting = {'prediction': 1., 'sparsity': 1., 'prior': 1., 'Wxx': 2., 'Wxxu': 0.5, 'Wxu': 0.}
...
for k in data_hat.keys():
    data[k] = data_hat[k][: MAX_SEGMENTS]
for k in data.keys():
...
for epoch in range(MAX_EPOCHS):
    ...
    save_path = os.path.join(PROJECT_DIR, 'experiments', 'ASFNR', 'estimation_parallel_extended_support.pkl')

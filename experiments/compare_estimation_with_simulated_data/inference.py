...
# load data
data_path = os.path.join(PROJECT_DIR, 'experiments', 'compare_estimation_with_simulated_data', 'du_DCM_RNN.pkl')
...
for epoch in range(MAX_EPOCHS):
    ...
    # save estimation
    save_path = os.path.join(PROJECT_DIR, 'experiments', 'compare_estimation_with_simulated_data', 'estimation.pkl')

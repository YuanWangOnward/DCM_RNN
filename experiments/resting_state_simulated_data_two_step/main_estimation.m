...
EXPERIMENT_PATH = '/Users/yuanwang/Google_Drive/projects/Gits/DCM_RNN/experiments/resting_state_simulated_data_two_step';
...
DCM_corrected.d = 0;
DCM_corrected.Y.y = DCM_corrected.Y.y * 10;
%% estimation
% DCM_estimated = spm_dcm_estimate_modified(DCM_corrected);

DCM_estimated = spm_dcm_fmri_csd_modified(DCM_corrected);

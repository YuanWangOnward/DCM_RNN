    ...
    for i_partition in range(N_PARTITIONS):
        ...
        for epoch in range(MAX_EPOCHS):
            ...
            for i_segment in range(N_SEGMENTS):
                ...
                # print('i_segment=' + str(i_segment) + ', i_segment=' + str(i_segment) + ', sum=' + str(i_segment + i_segment))
                ...
                # Display logs per epoch_inner step
                if count_total % CHECK_STEPS == 0:
                    ...
                    if IF_DATA_LOG:
                        ...
                        data_saved['epoch_inner'] = epoch

                        data_saved['N_SEGMENTS'] = N_PARTITIONS
